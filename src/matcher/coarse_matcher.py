...
# Default scale factors to search — centered tightly on nominal 10.0 ratio
...
def coarse_match(
    ...
    score_cutoff = max(best_score * RELATIVE_SCORE_THRESHOLD, MIN_ABSOLUTE_SCORE)
